...
export default function ChatWorkspace(props: ChatWorkspaceProps) {
  return (
    <section className="workspace-column workspace-chat-column">
      ...
      <div className="surface workspace-chat-messages">
        ...
        >
          ...
          />
          <button className="btn-primary min-w-[150px]" disabled={props.sending || !props.prompt.trim()}>
            Send Prompt
          </button>
          <button type="button" className="btn-secondary min-w-[150px]" onClick={props.onSaveLatestToProject}>
            Save to Project
          </button>
        </form>
      </div>
